...
func (o NameDto) MarshalJSON() ([]byte, error) {
...
type NullableNameDto struct {
	value *NameDto
	isSet bool
}

func (v NullableNameDto) Get() *NameDto {
	return v.value
}

func (v *NullableNameDto) Set(val *NameDto) {
	v.value = val
	v.isSet = true
}

func (v NullableNameDto) IsSet() bool {
	return v.isSet
}

func (v *NullableNameDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNameDto(val *NameDto) *NullableNameDto {
	return &NullableNameDto{value: val, isSet: true}
}

func (v NullableNameDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNameDto) UnmarshalJSON(src []byte) error {
	v.isSet = true

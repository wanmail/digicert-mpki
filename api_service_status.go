...
type ApiMpkiApiV1HealthExtensiveGetRequest struct {
	ctx context.Context
	ApiService *ServiceStatusApiService
}

func (r ApiMpkiApiV1HealthExtensiveGetRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.MpkiApiV1HealthExtensiveGetExecute(r)
}

/*
MpkiApiV1HealthExtensiveGet Query service health
...
Use this endpoint to perform a health check to query service status. An authorized request returns either HTTP status 200 - "UP" or 500 - "DOWN".
 ...
 @return ApiMpkiApiV1HealthExtensiveGetRequest
*/
func (a *ServiceStatusApiService) MpkiApiV1HealthExtensiveGet(ctx context.Context) ApiMpkiApiV1HealthExtensiveGetRequest {
	return ApiMpkiApiV1HealthExtensiveGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return string
func (a *ServiceStatusApiService) MpkiApiV1HealthExtensiveGetExecute(r ApiMpkiApiV1HealthExtensiveGetRequest) (string, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceStatusApiService.MpkiApiV1HealthExtensiveGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mpki/api/v1/health/extensive"
...
type ApiMpkiApiV1HelloGetRequest struct {
	ctx context.Context
	ApiService *ServiceStatusApiService
}

func (r ApiMpkiApiV1HelloGetRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.MpkiApiV1HelloGetExecute(r)
}

/*
MpkiApiV1HelloGet Query service status
...
Use this endpoint to query service status and test connectivity to the API. A successful response indicates that the service is live.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiMpkiApiV1HelloGetRequest
*/
func (a *ServiceStatusApiService) MpkiApiV1HelloGet(ctx context.Context) ApiMpkiApiV1HelloGetRequest {
	return ApiMpkiApiV1HelloGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *ServiceStatusApiService) MpkiApiV1HelloGetExecute(r ApiMpkiApiV1HelloGetRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceStatusApiService.MpkiApiV1HelloGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mpki/api/v1/hello"

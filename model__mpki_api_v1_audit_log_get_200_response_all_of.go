...
// MpkiApiV1AuditLogGet200ResponseAllOf struct for MpkiApiV1AuditLogGet200ResponseAllOf
type MpkiApiV1AuditLogGet200ResponseAllOf struct {
	Items []AuditLogItem `json:"items,omitempty"`
}
...
func NewMpkiApiV1AuditLogGet200ResponseAllOf() *MpkiApiV1AuditLogGet200ResponseAllOf {
	this := MpkiApiV1AuditLogGet200ResponseAllOf{}
	return &this
}
...
// SetItems gets a reference to the given []AuditLogItem and assigns it to the Items field.
func (o *MpkiApiV1AuditLogGet200ResponseAllOf) SetItems(v []AuditLogItem) {
	o.Items = v
}

func (o MpkiApiV1AuditLogGet200ResponseAllOf) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1AuditLogGet200ResponseAllOf struct {
	value *MpkiApiV1AuditLogGet200ResponseAllOf
	isSet bool
}

func (v NullableMpkiApiV1AuditLogGet200ResponseAllOf) Get() *MpkiApiV1AuditLogGet200ResponseAllOf {
	return v.value
}

func (v *NullableMpkiApiV1AuditLogGet200ResponseAllOf) Set(val *MpkiApiV1AuditLogGet200ResponseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1AuditLogGet200ResponseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1AuditLogGet200ResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1AuditLogGet200ResponseAllOf(val *MpkiApiV1AuditLogGet200ResponseAllOf) *NullableMpkiApiV1AuditLogGet200ResponseAllOf {
	return &NullableMpkiApiV1AuditLogGet200ResponseAllOf{value: val, isSet: true}
}

func (v NullableMpkiApiV1AuditLogGet200ResponseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1AuditLogGet200ResponseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

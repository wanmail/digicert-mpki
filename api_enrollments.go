...
/*
EnrollmentsApiService List enrollments
 ...
 * @param optional nil or *EnrollmentsApiMpkiApiV1EnrollmentDetailsGetOpts - Optional Parameters:
     * @param "SearchParameters" (optional.Interface of EnrollmentListParameters) - 
@return []PublicEnrollmentDetails
*/

type EnrollmentsApiMpkiApiV1EnrollmentDetailsGetOpts struct {
    SearchParameters optional.Interface
}

func (a *EnrollmentsApiService) MpkiApiV1EnrollmentDetailsGet(ctx context.Context, localVarOptionals *EnrollmentsApiMpkiApiV1EnrollmentDetailsGetOpts) ([]PublicEnrollmentDetails, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/enrollment-details/"
...
/*
EnrollmentsApiService Get enrollment details by ID
...
@return PublicEnrollmentDetails
*/
func (a *EnrollmentsApiService) MpkiApiV1EnrollmentDetailsIdentifierGet(ctx context.Context, identifier string) (PublicEnrollmentDetails, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/enrollment-details/{identifier}"
...
/*
EnrollmentsApiService Get enrollment details by enrollment code
...
*/
func (a *EnrollmentsApiService) MpkiApiV1EnrollmentEnrollmentCodeGet(ctx context.Context, enrollmentCode string, seatId string) (EnrollmentResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/enrollment/{enrollmentCode}"
	localVarPath = strings.Replace(localVarPath, "{"+"enrollmentCode"+"}", fmt.Sprintf("%v", enrollmentCode), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	localVarQueryParams.Add("seat_id", parameterToString(seatId, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
EnrollmentsApiService Create enrollment
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *EnrollmentsApiMpkiApiV1EnrollmentPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of V1EnrollmentBody) - 
@return EnrollmentResponse
*/

type EnrollmentsApiMpkiApiV1EnrollmentPostOpts struct {
    Body optional.Interface
}

func (a *EnrollmentsApiService) MpkiApiV1EnrollmentPost(ctx context.Context, localVarOptionals *EnrollmentsApiMpkiApiV1EnrollmentPostOpts) (EnrollmentResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/enrollment"
...
/*
EnrollmentsApiService Redeem enrollment
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *EnrollmentsApiMpkiApiV1EnrollmentRedeemPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of EnrollmentRedeemBody) - 
@return CertificateResponse
*/

type EnrollmentsApiMpkiApiV1EnrollmentRedeemPostOpts struct {
    Body optional.Interface
}

func (a *EnrollmentsApiService) MpkiApiV1EnrollmentRedeemPost(ctx context.Context, localVarOptionals *EnrollmentsApiMpkiApiV1EnrollmentRedeemPostOpts) (CertificateResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/enrollment/redeem"

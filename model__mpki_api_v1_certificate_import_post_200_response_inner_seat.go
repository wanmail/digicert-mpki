...
// MpkiApiV1CertificateImportPost200ResponseInnerSeat struct for MpkiApiV1CertificateImportPost200ResponseInnerSeat
type MpkiApiV1CertificateImportPost200ResponseInnerSeat struct {
...
func NewMpkiApiV1CertificateImportPost200ResponseInnerSeat() *MpkiApiV1CertificateImportPost200ResponseInnerSeat {
	this := MpkiApiV1CertificateImportPost200ResponseInnerSeat{}
	return &this
}
...
func (o MpkiApiV1CertificateImportPost200ResponseInnerSeat) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1CertificateImportPost200ResponseInnerSeat struct {
	value *MpkiApiV1CertificateImportPost200ResponseInnerSeat
	isSet bool
}

func (v NullableMpkiApiV1CertificateImportPost200ResponseInnerSeat) Get() *MpkiApiV1CertificateImportPost200ResponseInnerSeat {
	return v.value
}

func (v *NullableMpkiApiV1CertificateImportPost200ResponseInnerSeat) Set(val *MpkiApiV1CertificateImportPost200ResponseInnerSeat) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1CertificateImportPost200ResponseInnerSeat) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1CertificateImportPost200ResponseInnerSeat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1CertificateImportPost200ResponseInnerSeat(val *MpkiApiV1CertificateImportPost200ResponseInnerSeat) *NullableMpkiApiV1CertificateImportPost200ResponseInnerSeat {
	return &NullableMpkiApiV1CertificateImportPost200ResponseInnerSeat{value: val, isSet: true}
}

func (v NullableMpkiApiV1CertificateImportPost200ResponseInnerSeat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1CertificateImportPost200ResponseInnerSeat) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType Seat type ID
type MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType struct {
...
func NewMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType() *MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType {
	this := MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType{}
	return &this
}
...
func (o MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType struct {
	value *MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType
	isSet bool
}

func (v NullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType) Get() *MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType {
	return v.value
}

func (v *NullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType) Set(val *MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType(val *MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType) *NullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType {
	return &NullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType{value: val, isSet: true}
}

func (v NullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// MpkiApiV1EnrollmentRedeemPostRequestSeat struct for MpkiApiV1EnrollmentRedeemPostRequestSeat
type MpkiApiV1EnrollmentRedeemPostRequestSeat struct {
	Id *IdDto `json:"id,omitempty"`
}
...
func NewMpkiApiV1EnrollmentRedeemPostRequestSeat() *MpkiApiV1EnrollmentRedeemPostRequestSeat {
	this := MpkiApiV1EnrollmentRedeemPostRequestSeat{}
	return &this
}
...
// SetId gets a reference to the given IdDto and assigns it to the Id field.
func (o *MpkiApiV1EnrollmentRedeemPostRequestSeat) SetId(v IdDto) {
	o.Id = &v
}

func (o MpkiApiV1EnrollmentRedeemPostRequestSeat) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1EnrollmentRedeemPostRequestSeat struct {
	value *MpkiApiV1EnrollmentRedeemPostRequestSeat
	isSet bool
}

func (v NullableMpkiApiV1EnrollmentRedeemPostRequestSeat) Get() *MpkiApiV1EnrollmentRedeemPostRequestSeat {
	return v.value
}

func (v *NullableMpkiApiV1EnrollmentRedeemPostRequestSeat) Set(val *MpkiApiV1EnrollmentRedeemPostRequestSeat) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1EnrollmentRedeemPostRequestSeat) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1EnrollmentRedeemPostRequestSeat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1EnrollmentRedeemPostRequestSeat(val *MpkiApiV1EnrollmentRedeemPostRequestSeat) *NullableMpkiApiV1EnrollmentRedeemPostRequestSeat {
	return &NullableMpkiApiV1EnrollmentRedeemPostRequestSeat{value: val, isSet: true}
}

func (v NullableMpkiApiV1EnrollmentRedeemPostRequestSeat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1EnrollmentRedeemPostRequestSeat) UnmarshalJSON(src []byte) error {
	v.isSet = true

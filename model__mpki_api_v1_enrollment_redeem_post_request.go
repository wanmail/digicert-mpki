...
// MpkiApiV1EnrollmentRedeemPostRequest struct for MpkiApiV1EnrollmentRedeemPostRequest
type MpkiApiV1EnrollmentRedeemPostRequest struct {
	Seat *MpkiApiV1EnrollmentRedeemPostRequestSeat `json:"seat,omitempty"`
	Profile *MpkiApiV1EnrollmentRedeemPostRequestSeat `json:"profile,omitempty"`
...
func NewMpkiApiV1EnrollmentRedeemPostRequest() *MpkiApiV1EnrollmentRedeemPostRequest {
	this := MpkiApiV1EnrollmentRedeemPostRequest{}
	return &this
}
...
func (o *MpkiApiV1EnrollmentRedeemPostRequest) GetSeat() MpkiApiV1EnrollmentRedeemPostRequestSeat {
	if o == nil || o.Seat == nil {
		var ret MpkiApiV1EnrollmentRedeemPostRequestSeat
		return ret
	}
	return *o.Seat
}
...
// SetSeat gets a reference to the given MpkiApiV1EnrollmentRedeemPostRequestSeat and assigns it to the Seat field.
...
// SetProfile gets a reference to the given MpkiApiV1EnrollmentRedeemPostRequestSeat and assigns it to the Profile field.
...
func (o MpkiApiV1EnrollmentRedeemPostRequest) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1EnrollmentRedeemPostRequest struct {
	value *MpkiApiV1EnrollmentRedeemPostRequest
	isSet bool
}

func (v NullableMpkiApiV1EnrollmentRedeemPostRequest) Get() *MpkiApiV1EnrollmentRedeemPostRequest {
	return v.value
}

func (v *NullableMpkiApiV1EnrollmentRedeemPostRequest) Set(val *MpkiApiV1EnrollmentRedeemPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1EnrollmentRedeemPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1EnrollmentRedeemPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1EnrollmentRedeemPostRequest(val *MpkiApiV1EnrollmentRedeemPostRequest) *NullableMpkiApiV1EnrollmentRedeemPostRequest {
	return &NullableMpkiApiV1EnrollmentRedeemPostRequest{value: val, isSet: true}
}

func (v NullableMpkiApiV1EnrollmentRedeemPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1EnrollmentRedeemPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

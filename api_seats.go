 ...
 * @param optional nil or *SeatsApiMpkiApiV1SeatPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of V1SeatBody) - 
@return SeatDetails
*/

type SeatsApiMpkiApiV1SeatPostOpts struct {
    Body optional.Interface
}

func (a *SeatsApiService) MpkiApiV1SeatPost(ctx context.Context, localVarOptionals *SeatsApiMpkiApiV1SeatPostOpts) (SeatDetails, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/seat"
 ...
 * @param optional nil or *SeatsApiMpkiApiV1SeatSeatIdDeleteOpts - Optional Parameters:
     * @param "BusinessUnitId" (optional.Interface of string) -  Business unit ID
@return SeatDetails
*/

type SeatsApiMpkiApiV1SeatSeatIdDeleteOpts struct {
    BusinessUnitId optional.Interface
}

func (a *SeatsApiService) MpkiApiV1SeatSeatIdDelete(ctx context.Context, seatId string, seatTypeId string, localVarOptionals *SeatsApiMpkiApiV1SeatSeatIdDeleteOpts) (SeatDetails, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/seat/{seat_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"seat_id"+"}", fmt.Sprintf("%v", seatId), -1)
	...
	localVarQueryParams.Add("seat_type_id", parameterToString(seatTypeId, ""))
	// to determine the Content-Type header
...
/*
SeatsApiService Get seat by ID
 ...
 * @param seatId Seat ID
 * @param seatTypeId Seat Type ID
 * @param optional nil or *SeatsApiMpkiApiV1SeatSeatIdGetOpts - Optional Parameters:
     * @param "BusinessUnitId" (optional.Interface of string) -  Business unit ID.  As identical seat IDs may exist across various business units of the same account, the &#x60;business_unit_id&#x60; for the given seat must be specified as a query parameter if the account contains more than one business unit. 
@return InlineResponse200
*/

type SeatsApiMpkiApiV1SeatSeatIdGetOpts struct {
    BusinessUnitId optional.Interface
}

func (a *SeatsApiService) MpkiApiV1SeatSeatIdGet(ctx context.Context, seatId string, seatTypeId string, localVarOptionals *SeatsApiMpkiApiV1SeatSeatIdGetOpts) (InlineResponse200, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param seatId Seat ID
 * @param optional nil or *SeatsApiMpkiApiV1SeatSeatIdPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SeatSeatIdBody) - 
@return SeatDetails
*/

type SeatsApiMpkiApiV1SeatSeatIdPutOpts struct {
    Body optional.Interface
}

func (a *SeatsApiService) MpkiApiV1SeatSeatIdPut(ctx context.Context, seatId string, localVarOptionals *SeatsApiMpkiApiV1SeatSeatIdPutOpts) (SeatDetails, *http.Response, error) {
	var (
...
/*
SeatsApiService Get available seat types
...
*/
func (a *SeatsApiService) MpkiApiV1SeatTypesGet(ctx context.Context) ([]InlineResponse2001, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/seat-types"

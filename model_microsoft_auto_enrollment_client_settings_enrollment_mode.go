...
// MicrosoftAutoEnrollmentClientSettingsEnrollmentMode Object to store enrollment mode information
type MicrosoftAutoEnrollmentClientSettingsEnrollmentMode struct {
...
func NewMicrosoftAutoEnrollmentClientSettingsEnrollmentMode() *MicrosoftAutoEnrollmentClientSettingsEnrollmentMode {
	this := MicrosoftAutoEnrollmentClientSettingsEnrollmentMode{}
	return &this
}
...
func (o MicrosoftAutoEnrollmentClientSettingsEnrollmentMode) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode struct {
	value *MicrosoftAutoEnrollmentClientSettingsEnrollmentMode
	isSet bool
}

func (v NullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode) Get() *MicrosoftAutoEnrollmentClientSettingsEnrollmentMode {
	return v.value
}

func (v *NullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode) Set(val *MicrosoftAutoEnrollmentClientSettingsEnrollmentMode) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode(val *MicrosoftAutoEnrollmentClientSettingsEnrollmentMode) *NullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode {
	return &NullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode{value: val, isSet: true}
}

func (v NullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftAutoEnrollmentClientSettingsEnrollmentMode) UnmarshalJSON(src []byte) error {
	v.isSet = true

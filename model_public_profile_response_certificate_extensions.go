...
// PublicProfileResponseCertificateExtensions struct for PublicProfileResponseCertificateExtensions
type PublicProfileResponseCertificateExtensions struct {
	San *PublicProfileResponseCertificateExtensionsSan `json:"san,omitempty"`
}
...
func NewPublicProfileResponseCertificateExtensions() *PublicProfileResponseCertificateExtensions {
	this := PublicProfileResponseCertificateExtensions{}
	return &this
}
...
func (o *PublicProfileResponseCertificateExtensions) GetSan() PublicProfileResponseCertificateExtensionsSan {
	if o == nil || o.San == nil {
		var ret PublicProfileResponseCertificateExtensionsSan
		return ret
	}
	return *o.San
}
...
// SetSan gets a reference to the given PublicProfileResponseCertificateExtensionsSan and assigns it to the San field.
func (o *PublicProfileResponseCertificateExtensions) SetSan(v PublicProfileResponseCertificateExtensionsSan) {
	o.San = &v
}

func (o PublicProfileResponseCertificateExtensions) MarshalJSON() ([]byte, error) {
...
type NullablePublicProfileResponseCertificateExtensions struct {
	value *PublicProfileResponseCertificateExtensions
	isSet bool
}

func (v NullablePublicProfileResponseCertificateExtensions) Get() *PublicProfileResponseCertificateExtensions {
	return v.value
}

func (v *NullablePublicProfileResponseCertificateExtensions) Set(val *PublicProfileResponseCertificateExtensions) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicProfileResponseCertificateExtensions) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicProfileResponseCertificateExtensions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicProfileResponseCertificateExtensions(val *PublicProfileResponseCertificateExtensions) *NullablePublicProfileResponseCertificateExtensions {
	return &NullablePublicProfileResponseCertificateExtensions{value: val, isSet: true}
}

func (v NullablePublicProfileResponseCertificateExtensions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicProfileResponseCertificateExtensions) UnmarshalJSON(src []byte) error {
	v.isSet = true

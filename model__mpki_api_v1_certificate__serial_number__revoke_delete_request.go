...
// MpkiApiV1CertificateSerialNumberRevokeDeleteRequest struct for MpkiApiV1CertificateSerialNumberRevokeDeleteRequest
type MpkiApiV1CertificateSerialNumberRevokeDeleteRequest struct {
...
func NewMpkiApiV1CertificateSerialNumberRevokeDeleteRequest() *MpkiApiV1CertificateSerialNumberRevokeDeleteRequest {
	this := MpkiApiV1CertificateSerialNumberRevokeDeleteRequest{}
	return &this
}
...
func (o MpkiApiV1CertificateSerialNumberRevokeDeleteRequest) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest struct {
	value *MpkiApiV1CertificateSerialNumberRevokeDeleteRequest
	isSet bool
}

func (v NullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest) Get() *MpkiApiV1CertificateSerialNumberRevokeDeleteRequest {
	return v.value
}

func (v *NullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest) Set(val *MpkiApiV1CertificateSerialNumberRevokeDeleteRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest(val *MpkiApiV1CertificateSerialNumberRevokeDeleteRequest) *NullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest {
	return &NullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest{value: val, isSet: true}
}

func (v NullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1CertificateSerialNumberRevokeDeleteRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

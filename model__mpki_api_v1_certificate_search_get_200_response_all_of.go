...
// MpkiApiV1CertificateSearchGet200ResponseAllOf struct for MpkiApiV1CertificateSearchGet200ResponseAllOf
type MpkiApiV1CertificateSearchGet200ResponseAllOf struct {
	Items []PublicCertificateDetails `json:"items,omitempty"`
}
...
func NewMpkiApiV1CertificateSearchGet200ResponseAllOf() *MpkiApiV1CertificateSearchGet200ResponseAllOf {
	this := MpkiApiV1CertificateSearchGet200ResponseAllOf{}
	return &this
}
...
func (o *MpkiApiV1CertificateSearchGet200ResponseAllOf) GetItems() []PublicCertificateDetails {
	if o == nil || o.Items == nil {
		var ret []PublicCertificateDetails
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []PublicCertificateDetails and assigns it to the Items field.
func (o *MpkiApiV1CertificateSearchGet200ResponseAllOf) SetItems(v []PublicCertificateDetails) {
	o.Items = v
}

func (o MpkiApiV1CertificateSearchGet200ResponseAllOf) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1CertificateSearchGet200ResponseAllOf struct {
	value *MpkiApiV1CertificateSearchGet200ResponseAllOf
	isSet bool
}

func (v NullableMpkiApiV1CertificateSearchGet200ResponseAllOf) Get() *MpkiApiV1CertificateSearchGet200ResponseAllOf {
	return v.value
}

func (v *NullableMpkiApiV1CertificateSearchGet200ResponseAllOf) Set(val *MpkiApiV1CertificateSearchGet200ResponseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1CertificateSearchGet200ResponseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1CertificateSearchGet200ResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1CertificateSearchGet200ResponseAllOf(val *MpkiApiV1CertificateSearchGet200ResponseAllOf) *NullableMpkiApiV1CertificateSearchGet200ResponseAllOf {
	return &NullableMpkiApiV1CertificateSearchGet200ResponseAllOf{value: val, isSet: true}
}

func (v NullableMpkiApiV1CertificateSearchGet200ResponseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1CertificateSearchGet200ResponseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

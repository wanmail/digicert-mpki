...
// MpkiApiV1CertificateImportPostRequestInnerRevocation struct for MpkiApiV1CertificateImportPostRequestInnerRevocation
type MpkiApiV1CertificateImportPostRequestInnerRevocation struct {
	Revoked *bool `json:"revoked,omitempty"`
	Reason *string `json:"reason,omitempty"`
	RevokeDate *string `json:"revoke_date,omitempty"`
}
...
func NewMpkiApiV1CertificateImportPostRequestInnerRevocation() *MpkiApiV1CertificateImportPostRequestInnerRevocation {
	this := MpkiApiV1CertificateImportPostRequestInnerRevocation{}
	return &this
}
...
// GetRevokeDate returns the RevokeDate field value if set, zero value otherwise.
func (o *MpkiApiV1CertificateImportPostRequestInnerRevocation) GetRevokeDate() string {
	if o == nil || o.RevokeDate == nil {
		var ret string
		return ret
	}
	return *o.RevokeDate
...
// GetRevokeDateOk returns a tuple with the RevokeDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MpkiApiV1CertificateImportPostRequestInnerRevocation) GetRevokeDateOk() (*string, bool) {
	if o == nil || o.RevokeDate == nil {
		return nil, false
	}
	return o.RevokeDate, true
}
...
// SetRevokeDate gets a reference to the given string and assigns it to the RevokeDate field.
func (o *MpkiApiV1CertificateImportPostRequestInnerRevocation) SetRevokeDate(v string) {
	o.RevokeDate = &v
}

func (o MpkiApiV1CertificateImportPostRequestInnerRevocation) MarshalJSON() ([]byte, error) {
	...
	if o.RevokeDate != nil {
		toSerialize["revoke_date"] = o.RevokeDate
	}
	return json.Marshal(toSerialize)
}

type NullableMpkiApiV1CertificateImportPostRequestInnerRevocation struct {
	value *MpkiApiV1CertificateImportPostRequestInnerRevocation
	isSet bool
}

func (v NullableMpkiApiV1CertificateImportPostRequestInnerRevocation) Get() *MpkiApiV1CertificateImportPostRequestInnerRevocation {
	return v.value
}

func (v *NullableMpkiApiV1CertificateImportPostRequestInnerRevocation) Set(val *MpkiApiV1CertificateImportPostRequestInnerRevocation) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1CertificateImportPostRequestInnerRevocation) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1CertificateImportPostRequestInnerRevocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1CertificateImportPostRequestInnerRevocation(val *MpkiApiV1CertificateImportPostRequestInnerRevocation) *NullableMpkiApiV1CertificateImportPostRequestInnerRevocation {
	return &NullableMpkiApiV1CertificateImportPostRequestInnerRevocation{value: val, isSet: true}
}

func (v NullableMpkiApiV1CertificateImportPostRequestInnerRevocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1CertificateImportPostRequestInnerRevocation) UnmarshalJSON(src []byte) error {
	v.isSet = true

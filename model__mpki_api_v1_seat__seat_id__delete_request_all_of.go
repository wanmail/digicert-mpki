...
// MpkiApiV1SeatSeatIdDeleteRequestAllOf Seat details.  As identical seat IDs may exist across various business units of the same account, the `business_unit_id` for the given seat must be specified as a query parameter if the account contains more than one business unit. 
type MpkiApiV1SeatSeatIdDeleteRequestAllOf struct {
	SeatType *MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType `json:"seat_type,omitempty"`
...
func NewMpkiApiV1SeatSeatIdDeleteRequestAllOf() *MpkiApiV1SeatSeatIdDeleteRequestAllOf {
	this := MpkiApiV1SeatSeatIdDeleteRequestAllOf{}
	return &this
}
...
func (o *MpkiApiV1SeatSeatIdDeleteRequestAllOf) GetSeatType() MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType {
	if o == nil || o.SeatType == nil {
		var ret MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType
		return ret
	}
	return *o.SeatType
}
...
// SetSeatType gets a reference to the given MpkiApiV1SeatSeatIdDeleteRequestAllOfSeatType and assigns it to the SeatType field.
...
func (o MpkiApiV1SeatSeatIdDeleteRequestAllOf) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1SeatSeatIdDeleteRequestAllOf struct {
	value *MpkiApiV1SeatSeatIdDeleteRequestAllOf
	isSet bool
}

func (v NullableMpkiApiV1SeatSeatIdDeleteRequestAllOf) Get() *MpkiApiV1SeatSeatIdDeleteRequestAllOf {
	return v.value
}

func (v *NullableMpkiApiV1SeatSeatIdDeleteRequestAllOf) Set(val *MpkiApiV1SeatSeatIdDeleteRequestAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1SeatSeatIdDeleteRequestAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1SeatSeatIdDeleteRequestAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1SeatSeatIdDeleteRequestAllOf(val *MpkiApiV1SeatSeatIdDeleteRequestAllOf) *NullableMpkiApiV1SeatSeatIdDeleteRequestAllOf {
	return &NullableMpkiApiV1SeatSeatIdDeleteRequestAllOf{value: val, isSet: true}
}

func (v NullableMpkiApiV1SeatSeatIdDeleteRequestAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1SeatSeatIdDeleteRequestAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// MpkiApiV1EnrollmentPostRequestSeat struct for MpkiApiV1EnrollmentPostRequestSeat
type MpkiApiV1EnrollmentPostRequestSeat struct {
...
func NewMpkiApiV1EnrollmentPostRequestSeat(seatId string, email string) *MpkiApiV1EnrollmentPostRequestSeat {
	this := MpkiApiV1EnrollmentPostRequestSeat{}
	this.SeatId = seatId
	this.Email = email
	return &this
}
...
// GetSeatId returns the SeatId field value
...
// GetSeatIdOk returns a tuple with the SeatId field value
...
func (o MpkiApiV1EnrollmentPostRequestSeat) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1EnrollmentPostRequestSeat struct {
	value *MpkiApiV1EnrollmentPostRequestSeat
	isSet bool
}

func (v NullableMpkiApiV1EnrollmentPostRequestSeat) Get() *MpkiApiV1EnrollmentPostRequestSeat {
	return v.value
}

func (v *NullableMpkiApiV1EnrollmentPostRequestSeat) Set(val *MpkiApiV1EnrollmentPostRequestSeat) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1EnrollmentPostRequestSeat) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1EnrollmentPostRequestSeat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1EnrollmentPostRequestSeat(val *MpkiApiV1EnrollmentPostRequestSeat) *NullableMpkiApiV1EnrollmentPostRequestSeat {
	return &NullableMpkiApiV1EnrollmentPostRequestSeat{value: val, isSet: true}
}

func (v NullableMpkiApiV1EnrollmentPostRequestSeat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1EnrollmentPostRequestSeat) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// PublicProfileResponseCertificateSubject struct for PublicProfileResponseCertificateSubject
type PublicProfileResponseCertificateSubject struct {
...
func NewPublicProfileResponseCertificateSubject() *PublicProfileResponseCertificateSubject {
	this := PublicProfileResponseCertificateSubject{}
	return &this
}
...
func (o PublicProfileResponseCertificateSubject) MarshalJSON() ([]byte, error) {
...
type NullablePublicProfileResponseCertificateSubject struct {
	value *PublicProfileResponseCertificateSubject
	isSet bool
}

func (v NullablePublicProfileResponseCertificateSubject) Get() *PublicProfileResponseCertificateSubject {
	return v.value
}

func (v *NullablePublicProfileResponseCertificateSubject) Set(val *PublicProfileResponseCertificateSubject) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicProfileResponseCertificateSubject) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicProfileResponseCertificateSubject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicProfileResponseCertificateSubject(val *PublicProfileResponseCertificateSubject) *NullablePublicProfileResponseCertificateSubject {
	return &NullablePublicProfileResponseCertificateSubject{value: val, isSet: true}
}

func (v NullablePublicProfileResponseCertificateSubject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicProfileResponseCertificateSubject) UnmarshalJSON(src []byte) error {
	v.isSet = true

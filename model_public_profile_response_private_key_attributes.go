...
// PublicProfileResponsePrivateKeyAttributes struct for PublicProfileResponsePrivateKeyAttributes
type PublicProfileResponsePrivateKeyAttributes struct {
...
func NewPublicProfileResponsePrivateKeyAttributes() *PublicProfileResponsePrivateKeyAttributes {
	this := PublicProfileResponsePrivateKeyAttributes{}
	return &this
}
...
func (o PublicProfileResponsePrivateKeyAttributes) MarshalJSON() ([]byte, error) {
...
type NullablePublicProfileResponsePrivateKeyAttributes struct {
	value *PublicProfileResponsePrivateKeyAttributes
	isSet bool
}

func (v NullablePublicProfileResponsePrivateKeyAttributes) Get() *PublicProfileResponsePrivateKeyAttributes {
	return v.value
}

func (v *NullablePublicProfileResponsePrivateKeyAttributes) Set(val *PublicProfileResponsePrivateKeyAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicProfileResponsePrivateKeyAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicProfileResponsePrivateKeyAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicProfileResponsePrivateKeyAttributes(val *PublicProfileResponsePrivateKeyAttributes) *NullablePublicProfileResponsePrivateKeyAttributes {
	return &NullablePublicProfileResponsePrivateKeyAttributes{value: val, isSet: true}
}

func (v NullablePublicProfileResponsePrivateKeyAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicProfileResponsePrivateKeyAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
/*
CertificatesApiService Approve escrowed certificate recovery
 ...
 * @param optional nil or *CertificatesApiMpkiApiV1CertificateEscrowApproveSerialNumberPostOpts - Optional Parameters:
     * @param "ThumbprintSha256" (optional.String) -  Certificate thumbprint

*/

type CertificatesApiMpkiApiV1CertificateEscrowApproveSerialNumberPostOpts struct {
    ThumbprintSha256 optional.String
}

func (a *CertificatesApiService) MpkiApiV1CertificateEscrowApproveSerialNumberPost(ctx context.Context, serialNumber string, localVarOptionals *CertificatesApiMpkiApiV1CertificateEscrowApproveSerialNumberPostOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/certificate/escrow/approve/{serial_number}"
	localVarPath = strings.Replace(localVarPath, "{"+"serial_number"+"}", fmt.Sprintf("%v", serialNumber), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.ThumbprintSha256.IsSet() {
		localVarQueryParams.Add("thumbprint_sha256", parameterToString(localVarOptionals.ThumbprintSha256.Value(), ""))
	}
...
/*
CertificatesApiService Recover escrowed certificate by serial number
Use this endpoint to recover an escrowed certificate by the given serial number.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serialNumber Certificate serial number
 * @param optional nil or *CertificatesApiMpkiApiV1CertificateEscrowRecoverSerialNumberGetOpts - Optional Parameters:
     * @param "IncludeChain" (optional.Bool) -  If true, include CA certificates in response
@return CertificateResponse
*/

type CertificatesApiMpkiApiV1CertificateEscrowRecoverSerialNumberGetOpts struct {
    IncludeChain optional.Bool
}

func (a *CertificatesApiService) MpkiApiV1CertificateEscrowRecoverSerialNumberGet(ctx context.Context, serialNumber string, localVarOptionals *CertificatesApiMpkiApiV1CertificateEscrowRecoverSerialNumberGetOpts) (CertificateResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/certificate/escrow/recover/{serial_number}"
	localVarPath = strings.Replace(localVarPath, "{"+"serial_number"+"}", fmt.Sprintf("%v", serialNumber), -1)
	...
	if localVarOptionals != nil && localVarOptionals.IncludeChain.IsSet() {
		localVarQueryParams.Add("include_chain", parameterToString(localVarOptionals.IncludeChain.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
CertificatesApiService Import certificate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CertificatesApiMpkiApiV1CertificateImportPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of []V1CertificateimportBody) - 
     * @param "TrapSeatDuplicateError" (optional.Bool) -  If true, automatically appends the current timestamp to the seat ID value. This feature facilitates duplicate seat ID error handling.  
@return []InlineResponse2002
*/

type CertificatesApiMpkiApiV1CertificateImportPostOpts struct {
    Body optional.Interface
    TrapSeatDuplicateError optional.Bool
}

func (a *CertificatesApiService) MpkiApiV1CertificateImportPost(ctx context.Context, localVarOptionals *CertificatesApiMpkiApiV1CertificateImportPostOpts) ([]InlineResponse2002, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/certificate-import"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.TrapSeatDuplicateError.IsSet() {
		localVarQueryParams.Add("trap_seat_duplicate_error", parameterToString(localVarOptionals.TrapSeatDuplicateError.Value(), ""))
	}
	// to determine the Content-Type header
...
/*
CertificatesApiService Issue certificate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CertificatesApiMpkiApiV1CertificatePostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of V1CertificateBody) - 
@return CertificateResponse
*/

type CertificatesApiMpkiApiV1CertificatePostOpts struct {
    Body optional.Interface
}

func (a *CertificatesApiService) MpkiApiV1CertificatePost(ctx context.Context, localVarOptionals *CertificatesApiMpkiApiV1CertificatePostOpts) (CertificateResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/certificate"
...
/*
CertificatesApiService Search certificates
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CertificatesApiMpkiApiV1CertificateSearchGetOpts - Optional Parameters:
     * @param "SearchParameters" (optional.Interface of CertificateSearchParameters) - 
     * @param "PagingParameters" (optional.Interface of PagingParameters) - 
@return InlineResponse2003
*/

type CertificatesApiMpkiApiV1CertificateSearchGetOpts struct {
    SearchParameters optional.Interface
    PagingParameters optional.Interface
}

func (a *CertificatesApiService) MpkiApiV1CertificateSearchGet(ctx context.Context, localVarOptionals *CertificatesApiMpkiApiV1CertificateSearchGetOpts) (InlineResponse2003, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/certificate-search"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.SearchParameters.IsSet() {
		localVarQueryParams.Add("Search parameters", parameterToString(localVarOptionals.SearchParameters.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.PagingParameters.IsSet() {
		localVarQueryParams.Add("Paging parameters", parameterToString(localVarOptionals.PagingParameters.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
CertificatesApiService Get certificate by serial number
Use this endpoint to get the details of a given certificate serial number.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serialNumber Certificate serial number
@return PublicCertificateDetails
*/
func (a *CertificatesApiService) MpkiApiV1CertificateSerialNumberGet(ctx context.Context, serialNumber string) (PublicCertificateDetails, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/certificate/{serial_number}"
	localVarPath = strings.Replace(localVarPath, "{"+"serial_number"+"}", fmt.Sprintf("%v", serialNumber), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PublicCertificateDetails
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
CertificatesApiService Renew certificate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serialNumber Certificate serial number
 * @param optional nil or *CertificatesApiMpkiApiV1CertificateSerialNumberRenewPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SerialNumberRenewBody) - 
     * @param "ThumbprintSha256" (optional.String) -  Certificate thumbprint
@return CertificateResponse
*/

type CertificatesApiMpkiApiV1CertificateSerialNumberRenewPostOpts struct {
    Body optional.Interface
    ThumbprintSha256 optional.String
}

func (a *CertificatesApiService) MpkiApiV1CertificateSerialNumberRenewPost(ctx context.Context, serialNumber string, localVarOptionals *CertificatesApiMpkiApiV1CertificateSerialNumberRenewPostOpts) (CertificateResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/certificate/{serial_number}/renew"
	localVarPath = strings.Replace(localVarPath, "{"+"serial_number"+"}", fmt.Sprintf("%v", serialNumber), -1)
...
/*
CertificatesApiService Resume suspended certificate
Use this endpoint to resume the previously suspended certificate with the given serial number.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serialNumber Certificate serial number

*/
func (a *CertificatesApiService) MpkiApiV1CertificateSerialNumberRevokeDelete(ctx context.Context, serialNumber string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/certificate/{serial_number}/revoke"
	localVarPath = strings.Replace(localVarPath, "{"+"serial_number"+"}", fmt.Sprintf("%v", serialNumber), -1)
...
/*
CertificatesApiService Revoke certificate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serialNumber Certificate serial number
 * @param optional nil or *CertificatesApiMpkiApiV1CertificateSerialNumberRevokePutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SerialNumberRevokeBody) - 
     * @param "ThumbprintSha256" (optional.String) -  Certificate thumbprint

*/

type CertificatesApiMpkiApiV1CertificateSerialNumberRevokePutOpts struct {
    Body optional.Interface
    ThumbprintSha256 optional.String
}

func (a *CertificatesApiService) MpkiApiV1CertificateSerialNumberRevokePut(ctx context.Context, serialNumber string, localVarOptionals *CertificatesApiMpkiApiV1CertificateSerialNumberRevokePutOpts) (*http.Response, error) {
	var (

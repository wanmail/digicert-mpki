...
/*
ProfilesApiService List profiles
 ...
 * @param optional nil or *ProfilesApiMpkiApiV1ProfileGetOpts - Optional Parameters:
     * @param "ApiTokenId" (optional.String) -  Limit results to profiles bound to the given API token ID
@return [][]PublicProfileResponse
*/

type ProfilesApiMpkiApiV1ProfileGetOpts struct {
    ApiTokenId optional.String
}

func (a *ProfilesApiService) MpkiApiV1ProfileGet(ctx context.Context, localVarOptionals *ProfilesApiMpkiApiV1ProfileGetOpts) ([][]PublicProfileResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/profile"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.ApiTokenId.IsSet() {
		localVarQueryParams.Add("api_token_id", parameterToString(localVarOptionals.ApiTokenId.Value(), ""))
	}
...
/*
ProfilesApiService Get profile by ID
Use this endpoint to get the details for a given certificate profile ID.  
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param profileId Certificate profile ID
@return PublicProfileResponse
*/
func (a *ProfilesApiService) MpkiApiV1ProfileProfileIdGet(ctx context.Context, profileId string) (PublicProfileResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mpki/api/v1/profile/{profile_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"profile_id"+"}", fmt.Sprintf("%v", profileId), -1)

...
// CertificateExtensionsSan struct for CertificateExtensionsSan
type CertificateExtensionsSan struct {
...
func (o CertificateExtensionsSan) MarshalJSON() ([]byte, error) {
...
type NullableCertificateExtensionsSan struct {
	value *CertificateExtensionsSan
	isSet bool
}

func (v NullableCertificateExtensionsSan) Get() *CertificateExtensionsSan {
	return v.value
}

func (v *NullableCertificateExtensionsSan) Set(val *CertificateExtensionsSan) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateExtensionsSan) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateExtensionsSan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateExtensionsSan(val *CertificateExtensionsSan) *NullableCertificateExtensionsSan {
	return &NullableCertificateExtensionsSan{value: val, isSet: true}
}

func (v NullableCertificateExtensionsSan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateExtensionsSan) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// MpkiApiV1CertificatePostRequestAttributes struct for MpkiApiV1CertificatePostRequestAttributes
type MpkiApiV1CertificatePostRequestAttributes struct {
...
func NewMpkiApiV1CertificatePostRequestAttributes() *MpkiApiV1CertificatePostRequestAttributes {
	this := MpkiApiV1CertificatePostRequestAttributes{}
	return &this
}
...
// SetSchema gets a reference to the given CertificateAttributes and assigns it to the Schema field.
func (o *MpkiApiV1CertificatePostRequestAttributes) SetSchema(v CertificateAttributes) {
	o.Schema = &v
}

func (o MpkiApiV1CertificatePostRequestAttributes) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1CertificatePostRequestAttributes struct {
	value *MpkiApiV1CertificatePostRequestAttributes
	isSet bool
}

func (v NullableMpkiApiV1CertificatePostRequestAttributes) Get() *MpkiApiV1CertificatePostRequestAttributes {
	return v.value
}

func (v *NullableMpkiApiV1CertificatePostRequestAttributes) Set(val *MpkiApiV1CertificatePostRequestAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1CertificatePostRequestAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1CertificatePostRequestAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1CertificatePostRequestAttributes(val *MpkiApiV1CertificatePostRequestAttributes) *NullableMpkiApiV1CertificatePostRequestAttributes {
	return &NullableMpkiApiV1CertificatePostRequestAttributes{value: val, isSet: true}
}

func (v NullableMpkiApiV1CertificatePostRequestAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1CertificatePostRequestAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true

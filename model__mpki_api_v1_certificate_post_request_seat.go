...
// MpkiApiV1CertificatePostRequestSeat struct for MpkiApiV1CertificatePostRequestSeat
type MpkiApiV1CertificatePostRequestSeat struct {
...
func NewMpkiApiV1CertificatePostRequestSeat() *MpkiApiV1CertificatePostRequestSeat {
	this := MpkiApiV1CertificatePostRequestSeat{}
	return &this
}
...
func (o MpkiApiV1CertificatePostRequestSeat) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1CertificatePostRequestSeat struct {
	value *MpkiApiV1CertificatePostRequestSeat
	isSet bool
}

func (v NullableMpkiApiV1CertificatePostRequestSeat) Get() *MpkiApiV1CertificatePostRequestSeat {
	return v.value
}

func (v *NullableMpkiApiV1CertificatePostRequestSeat) Set(val *MpkiApiV1CertificatePostRequestSeat) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1CertificatePostRequestSeat) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1CertificatePostRequestSeat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1CertificatePostRequestSeat(val *MpkiApiV1CertificatePostRequestSeat) *NullableMpkiApiV1CertificatePostRequestSeat {
	return &NullableMpkiApiV1CertificatePostRequestSeat{value: val, isSet: true}
}

func (v NullableMpkiApiV1CertificatePostRequestSeat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1CertificatePostRequestSeat) UnmarshalJSON(src []byte) error {
	v.isSet = true

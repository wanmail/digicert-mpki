...
// PublicProfileResponseCertificateIssuerAllOf struct for PublicProfileResponseCertificateIssuerAllOf
type PublicProfileResponseCertificateIssuerAllOf struct {
...
func NewPublicProfileResponseCertificateIssuerAllOf() *PublicProfileResponseCertificateIssuerAllOf {
	this := PublicProfileResponseCertificateIssuerAllOf{}
	return &this
}
...
func (o PublicProfileResponseCertificateIssuerAllOf) MarshalJSON() ([]byte, error) {
...
type NullablePublicProfileResponseCertificateIssuerAllOf struct {
	value *PublicProfileResponseCertificateIssuerAllOf
	isSet bool
}

func (v NullablePublicProfileResponseCertificateIssuerAllOf) Get() *PublicProfileResponseCertificateIssuerAllOf {
	return v.value
}

func (v *NullablePublicProfileResponseCertificateIssuerAllOf) Set(val *PublicProfileResponseCertificateIssuerAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicProfileResponseCertificateIssuerAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicProfileResponseCertificateIssuerAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicProfileResponseCertificateIssuerAllOf(val *PublicProfileResponseCertificateIssuerAllOf) *NullablePublicProfileResponseCertificateIssuerAllOf {
	return &NullablePublicProfileResponseCertificateIssuerAllOf{value: val, isSet: true}
}

func (v NullablePublicProfileResponseCertificateIssuerAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicProfileResponseCertificateIssuerAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

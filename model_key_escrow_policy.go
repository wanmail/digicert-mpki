...
// KeyEscrowPolicy struct for KeyEscrowPolicy
type KeyEscrowPolicy struct {
...
// GetKeyEscrowEnabled returns the KeyEscrowEnabled field value if set, zero value otherwise.
func (o *KeyEscrowPolicy) GetKeyEscrowEnabled() bool {
	if o == nil || o.KeyEscrowEnabled == nil {
		var ret bool
		return ret
	}
	return *o.KeyEscrowEnabled
}

// GetKeyEscrowEnabledOk returns a tuple with the KeyEscrowEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *KeyEscrowPolicy) GetKeyEscrowEnabledOk() (*bool, bool) {
	if o == nil || o.KeyEscrowEnabled == nil {
		return nil, false
	}
	return o.KeyEscrowEnabled, true
}
...
// SetKeyEscrowEnabled gets a reference to the given bool and assigns it to the KeyEscrowEnabled field.
func (o *KeyEscrowPolicy) SetKeyEscrowEnabled(v bool) {
	o.KeyEscrowEnabled = &v
}

func (o KeyEscrowPolicy) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.KeyEscrowEnabled != nil {
		toSerialize["key_escrow_enabled"] = o.KeyEscrowEnabled
	}
	return json.Marshal(toSerialize)
}

type NullableKeyEscrowPolicy struct {
	value *KeyEscrowPolicy
	isSet bool
}

func (v NullableKeyEscrowPolicy) Get() *KeyEscrowPolicy {
	return v.value
}

func (v *NullableKeyEscrowPolicy) Set(val *KeyEscrowPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyEscrowPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyEscrowPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyEscrowPolicy(val *KeyEscrowPolicy) *NullableKeyEscrowPolicy {
	return &NullableKeyEscrowPolicy{value: val, isSet: true}
}

func (v NullableKeyEscrowPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyEscrowPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true

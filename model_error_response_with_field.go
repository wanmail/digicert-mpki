...
// ErrorResponseWithField struct for ErrorResponseWithField
...
func (o ErrorResponseWithField) MarshalJSON() ([]byte, error) {
...
type NullableErrorResponseWithField struct {
	value *ErrorResponseWithField
	isSet bool
}

func (v NullableErrorResponseWithField) Get() *ErrorResponseWithField {
	return v.value
}

func (v *NullableErrorResponseWithField) Set(val *ErrorResponseWithField) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorResponseWithField) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorResponseWithField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorResponseWithField(val *ErrorResponseWithField) *NullableErrorResponseWithField {
	return &NullableErrorResponseWithField{value: val, isSet: true}
}

func (v NullableErrorResponseWithField) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorResponseWithField) UnmarshalJSON(src []byte) error {
	v.isSet = true

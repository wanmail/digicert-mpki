...
// MpkiApiV1CertificateSearchGet200Response struct for MpkiApiV1CertificateSearchGet200Response
type MpkiApiV1CertificateSearchGet200Response struct {
	Total int32 `json:"total"`
	Offset int32 `json:"offset"`
	Limit int32 `json:"limit"`
	Items []PublicCertificateDetails `json:"items"`
}
...
func NewMpkiApiV1CertificateSearchGet200Response(total int32, offset int32, limit int32, items []PublicCertificateDetails) *MpkiApiV1CertificateSearchGet200Response {
	this := MpkiApiV1CertificateSearchGet200Response{}
	this.Total = total
	this.Offset = offset
	this.Limit = limit
	this.Items = items
...
func (o MpkiApiV1CertificateSearchGet200Response) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1CertificateSearchGet200Response struct {
	value *MpkiApiV1CertificateSearchGet200Response
	isSet bool
}

func (v NullableMpkiApiV1CertificateSearchGet200Response) Get() *MpkiApiV1CertificateSearchGet200Response {
	return v.value
}

func (v *NullableMpkiApiV1CertificateSearchGet200Response) Set(val *MpkiApiV1CertificateSearchGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1CertificateSearchGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1CertificateSearchGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1CertificateSearchGet200Response(val *MpkiApiV1CertificateSearchGet200Response) *NullableMpkiApiV1CertificateSearchGet200Response {
	return &NullableMpkiApiV1CertificateSearchGet200Response{value: val, isSet: true}
}

func (v NullableMpkiApiV1CertificateSearchGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1CertificateSearchGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

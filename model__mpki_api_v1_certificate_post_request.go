...
// MpkiApiV1CertificatePostRequest struct for MpkiApiV1CertificatePostRequest
type MpkiApiV1CertificatePostRequest struct {
	Profile *IdDto `json:"profile,omitempty"`
	...
	Attributes *MpkiApiV1CertificatePostRequestAttributes `json:"attributes,omitempty"`
}
...
func NewMpkiApiV1CertificatePostRequest() *MpkiApiV1CertificatePostRequest {
	this := MpkiApiV1CertificatePostRequest{}
	return &this
}
...
// SetProfile gets a reference to the given IdDto and assigns it to the Profile field.
...
func (o *MpkiApiV1CertificatePostRequest) GetAttributes() MpkiApiV1CertificatePostRequestAttributes {
	if o == nil || o.Attributes == nil {
		var ret MpkiApiV1CertificatePostRequestAttributes
		return ret
	}
	return *o.Attributes
}
...
// SetAttributes gets a reference to the given MpkiApiV1CertificatePostRequestAttributes and assigns it to the Attributes field.
func (o *MpkiApiV1CertificatePostRequest) SetAttributes(v MpkiApiV1CertificatePostRequestAttributes) {
	o.Attributes = &v
}

func (o MpkiApiV1CertificatePostRequest) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1CertificatePostRequest struct {
	value *MpkiApiV1CertificatePostRequest
	isSet bool
}

func (v NullableMpkiApiV1CertificatePostRequest) Get() *MpkiApiV1CertificatePostRequest {
	return v.value
}

func (v *NullableMpkiApiV1CertificatePostRequest) Set(val *MpkiApiV1CertificatePostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1CertificatePostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1CertificatePostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1CertificatePostRequest(val *MpkiApiV1CertificatePostRequest) *NullableMpkiApiV1CertificatePostRequest {
	return &NullableMpkiApiV1CertificatePostRequest{value: val, isSet: true}
}

func (v NullableMpkiApiV1CertificatePostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1CertificatePostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// PublicEnrollmentDetailsSeat struct for PublicEnrollmentDetailsSeat
type PublicEnrollmentDetailsSeat struct {
...
func NewPublicEnrollmentDetailsSeat() *PublicEnrollmentDetailsSeat {
	this := PublicEnrollmentDetailsSeat{}
	return &this
}
...
func (o PublicEnrollmentDetailsSeat) MarshalJSON() ([]byte, error) {
...
type NullablePublicEnrollmentDetailsSeat struct {
	value *PublicEnrollmentDetailsSeat
	isSet bool
}

func (v NullablePublicEnrollmentDetailsSeat) Get() *PublicEnrollmentDetailsSeat {
	return v.value
}

func (v *NullablePublicEnrollmentDetailsSeat) Set(val *PublicEnrollmentDetailsSeat) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicEnrollmentDetailsSeat) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicEnrollmentDetailsSeat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicEnrollmentDetailsSeat(val *PublicEnrollmentDetailsSeat) *NullablePublicEnrollmentDetailsSeat {
	return &NullablePublicEnrollmentDetailsSeat{value: val, isSet: true}
}

func (v NullablePublicEnrollmentDetailsSeat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicEnrollmentDetailsSeat) UnmarshalJSON(src []byte) error {
	v.isSet = true

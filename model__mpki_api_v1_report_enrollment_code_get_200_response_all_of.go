...
// MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf struct for MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf
type MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf struct {
	Items []ExternalEnrollmentReport `json:"items,omitempty"`
}
...
func NewMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf() *MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf {
	this := MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf{}
	return &this
}
...
// SetItems gets a reference to the given []ExternalEnrollmentReport and assigns it to the Items field.
func (o *MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) SetItems(v []ExternalEnrollmentReport) {
	o.Items = v
}

func (o MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf struct {
	value *MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf
	isSet bool
}

func (v NullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) Get() *MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf {
	return v.value
}

func (v *NullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) Set(val *MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf(val *MpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) *NullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf {
	return &NullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf{value: val, isSet: true}
}

func (v NullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1ReportEnrollmentCodeGet200ResponseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

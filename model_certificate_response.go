...
// GetPkcs12Password returns the Pkcs12Password field value if set, zero value otherwise.
func (o *CertificateResponse) GetPkcs12Password() string {
	if o == nil || o.Pkcs12Password == nil {
		var ret string
		return ret
	}
	return *o.Pkcs12Password
}

// GetPkcs12PasswordOk returns a tuple with the Pkcs12Password field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CertificateResponse) GetPkcs12PasswordOk() (*string, bool) {
	if o == nil || o.Pkcs12Password == nil {
		return nil, false
	}
	return o.Pkcs12Password, true
}
...
// SetPkcs12Password gets a reference to the given string and assigns it to the Pkcs12Password field.
...
func (o CertificateResponse) MarshalJSON() ([]byte, error) {
	...
	if o.Pkcs12Password != nil {
		toSerialize["pkcs12Password"] = o.Pkcs12Password
	}

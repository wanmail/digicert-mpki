...
// MpkiApiV1SeatSeatIdDeleteRequest struct for MpkiApiV1SeatSeatIdDeleteRequest
type MpkiApiV1SeatSeatIdDeleteRequest struct {
...
func NewMpkiApiV1SeatSeatIdDeleteRequest() *MpkiApiV1SeatSeatIdDeleteRequest {
	this := MpkiApiV1SeatSeatIdDeleteRequest{}
	return &this
}
...
func (o MpkiApiV1SeatSeatIdDeleteRequest) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1SeatSeatIdDeleteRequest struct {
	value *MpkiApiV1SeatSeatIdDeleteRequest
	isSet bool
}

func (v NullableMpkiApiV1SeatSeatIdDeleteRequest) Get() *MpkiApiV1SeatSeatIdDeleteRequest {
	return v.value
}

func (v *NullableMpkiApiV1SeatSeatIdDeleteRequest) Set(val *MpkiApiV1SeatSeatIdDeleteRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1SeatSeatIdDeleteRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1SeatSeatIdDeleteRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1SeatSeatIdDeleteRequest(val *MpkiApiV1SeatSeatIdDeleteRequest) *NullableMpkiApiV1SeatSeatIdDeleteRequest {
	return &NullableMpkiApiV1SeatSeatIdDeleteRequest{value: val, isSet: true}
}

func (v NullableMpkiApiV1SeatSeatIdDeleteRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1SeatSeatIdDeleteRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

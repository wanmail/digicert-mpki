...
// PublicCertificateDetailsRevocation struct for PublicCertificateDetailsRevocation
type PublicCertificateDetailsRevocation struct {
...
func NewPublicCertificateDetailsRevocation() *PublicCertificateDetailsRevocation {
	this := PublicCertificateDetailsRevocation{}
	return &this
}
...
func (o PublicCertificateDetailsRevocation) MarshalJSON() ([]byte, error) {
...
type NullablePublicCertificateDetailsRevocation struct {
	value *PublicCertificateDetailsRevocation
	isSet bool
}

func (v NullablePublicCertificateDetailsRevocation) Get() *PublicCertificateDetailsRevocation {
	return v.value
}

func (v *NullablePublicCertificateDetailsRevocation) Set(val *PublicCertificateDetailsRevocation) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicCertificateDetailsRevocation) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicCertificateDetailsRevocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicCertificateDetailsRevocation(val *PublicCertificateDetailsRevocation) *NullablePublicCertificateDetailsRevocation {
	return &NullablePublicCertificateDetailsRevocation{value: val, isSet: true}
}

func (v NullablePublicCertificateDetailsRevocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicCertificateDetailsRevocation) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// MicrosoftAutoEnrollmentClientSettingsCryptoProviders Object to store information about usable Crypto Providers
type MicrosoftAutoEnrollmentClientSettingsCryptoProviders struct {
	// Whether this object is modifiable
	Modifiable *bool `json:"modifiable,omitempty"`
	// Describes the list of usable Crypto Providers, empty array allows any provider available on subject's computer
...
func NewMicrosoftAutoEnrollmentClientSettingsCryptoProviders() *MicrosoftAutoEnrollmentClientSettingsCryptoProviders {
	this := MicrosoftAutoEnrollmentClientSettingsCryptoProviders{}
	return &this
}
...
func (o MicrosoftAutoEnrollmentClientSettingsCryptoProviders) MarshalJSON() ([]byte, error) {
...
type NullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders struct {
	value *MicrosoftAutoEnrollmentClientSettingsCryptoProviders
	isSet bool
}

func (v NullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders) Get() *MicrosoftAutoEnrollmentClientSettingsCryptoProviders {
	return v.value
}

func (v *NullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders) Set(val *MicrosoftAutoEnrollmentClientSettingsCryptoProviders) {
	v.value = val
	v.isSet = true
}

func (v NullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders) IsSet() bool {
	return v.isSet
}

func (v *NullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders(val *MicrosoftAutoEnrollmentClientSettingsCryptoProviders) *NullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders {
	return &NullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders{value: val, isSet: true}
}

func (v NullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMicrosoftAutoEnrollmentClientSettingsCryptoProviders) UnmarshalJSON(src []byte) error {
	v.isSet = true

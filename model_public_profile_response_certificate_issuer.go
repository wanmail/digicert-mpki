...
// PublicProfileResponseCertificateIssuer struct for PublicProfileResponseCertificateIssuer
type PublicProfileResponseCertificateIssuer struct {
...
func NewPublicProfileResponseCertificateIssuer() *PublicProfileResponseCertificateIssuer {
	this := PublicProfileResponseCertificateIssuer{}
	return &this
}
...
func (o PublicProfileResponseCertificateIssuer) MarshalJSON() ([]byte, error) {
...
type NullablePublicProfileResponseCertificateIssuer struct {
	value *PublicProfileResponseCertificateIssuer
	isSet bool
}

func (v NullablePublicProfileResponseCertificateIssuer) Get() *PublicProfileResponseCertificateIssuer {
	return v.value
}

func (v *NullablePublicProfileResponseCertificateIssuer) Set(val *PublicProfileResponseCertificateIssuer) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicProfileResponseCertificateIssuer) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicProfileResponseCertificateIssuer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicProfileResponseCertificateIssuer(val *PublicProfileResponseCertificateIssuer) *NullablePublicProfileResponseCertificateIssuer {
	return &NullablePublicProfileResponseCertificateIssuer{value: val, isSet: true}
}

func (v NullablePublicProfileResponseCertificateIssuer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicProfileResponseCertificateIssuer) UnmarshalJSON(src []byte) error {
	v.isSet = true

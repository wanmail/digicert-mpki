...
// CertificateExtensions struct for CertificateExtensions
type CertificateExtensions struct {
	San *CertificateExtensionsSan `json:"san,omitempty"`
}
...
func (o *CertificateExtensions) GetSan() CertificateExtensionsSan {
	if o == nil || o.San == nil {
		var ret CertificateExtensionsSan
		return ret
	}
	return *o.San
}
...
// SetSan gets a reference to the given CertificateExtensionsSan and assigns it to the San field.
func (o *CertificateExtensions) SetSan(v CertificateExtensionsSan) {
	o.San = &v
}

func (o CertificateExtensions) MarshalJSON() ([]byte, error) {
...
type NullableCertificateExtensions struct {
	value *CertificateExtensions
	isSet bool
}

func (v NullableCertificateExtensions) Get() *CertificateExtensions {
	return v.value
}

func (v *NullableCertificateExtensions) Set(val *CertificateExtensions) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateExtensions) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateExtensions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateExtensions(val *CertificateExtensions) *NullableCertificateExtensions {
	return &NullableCertificateExtensions{value: val, isSet: true}
}

func (v NullableCertificateExtensions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateExtensions) UnmarshalJSON(src []byte) error {
	v.isSet = true

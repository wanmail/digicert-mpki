...
// MpkiApiV1SeatPostRequest struct for MpkiApiV1SeatPostRequest
type MpkiApiV1SeatPostRequest struct {
...
func (o MpkiApiV1SeatPostRequest) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1SeatPostRequest struct {
	value *MpkiApiV1SeatPostRequest
	isSet bool
}

func (v NullableMpkiApiV1SeatPostRequest) Get() *MpkiApiV1SeatPostRequest {
	return v.value
}

func (v *NullableMpkiApiV1SeatPostRequest) Set(val *MpkiApiV1SeatPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1SeatPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1SeatPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1SeatPostRequest(val *MpkiApiV1SeatPostRequest) *NullableMpkiApiV1SeatPostRequest {
	return &NullableMpkiApiV1SeatPostRequest{value: val, isSet: true}
}

func (v NullableMpkiApiV1SeatPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1SeatPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

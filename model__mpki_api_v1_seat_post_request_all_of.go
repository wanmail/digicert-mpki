...
// MpkiApiV1SeatPostRequestAllOf Seat details.  If your account contains more than one business unit, `business_unit_id` is required. 
type MpkiApiV1SeatPostRequestAllOf struct {
	// Primary seat identifier
	SeatId *string `json:"seat_id,omitempty"`
	// Seat type identifier
	SeatType map[string]interface{} `json:"seat_type,omitempty"`
...
func NewMpkiApiV1SeatPostRequestAllOf() *MpkiApiV1SeatPostRequestAllOf {
	this := MpkiApiV1SeatPostRequestAllOf{}
	return &this
}
...
// SetSeatType gets a reference to the given map[string]interface{} and assigns it to the SeatType field.
...
func (o MpkiApiV1SeatPostRequestAllOf) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1SeatPostRequestAllOf struct {
	value *MpkiApiV1SeatPostRequestAllOf
	isSet bool
}

func (v NullableMpkiApiV1SeatPostRequestAllOf) Get() *MpkiApiV1SeatPostRequestAllOf {
	return v.value
}

func (v *NullableMpkiApiV1SeatPostRequestAllOf) Set(val *MpkiApiV1SeatPostRequestAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1SeatPostRequestAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1SeatPostRequestAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1SeatPostRequestAllOf(val *MpkiApiV1SeatPostRequestAllOf) *NullableMpkiApiV1SeatPostRequestAllOf {
	return &NullableMpkiApiV1SeatPostRequestAllOf{value: val, isSet: true}
}

func (v NullableMpkiApiV1SeatPostRequestAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1SeatPostRequestAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// PublicProfileResponseCertificateExtensionsSan struct for PublicProfileResponseCertificateExtensionsSan
type PublicProfileResponseCertificateExtensionsSan struct {
	Critical *bool `json:"critical,omitempty"`
	Attributes []PublicProfileField `json:"attributes,omitempty"`
}
...
func NewPublicProfileResponseCertificateExtensionsSan() *PublicProfileResponseCertificateExtensionsSan {
	this := PublicProfileResponseCertificateExtensionsSan{}
	return &this
}
...
// SetAttributes gets a reference to the given []PublicProfileField and assigns it to the Attributes field.
func (o *PublicProfileResponseCertificateExtensionsSan) SetAttributes(v []PublicProfileField) {
	o.Attributes = v
}

func (o PublicProfileResponseCertificateExtensionsSan) MarshalJSON() ([]byte, error) {
...
type NullablePublicProfileResponseCertificateExtensionsSan struct {
	value *PublicProfileResponseCertificateExtensionsSan
	isSet bool
}

func (v NullablePublicProfileResponseCertificateExtensionsSan) Get() *PublicProfileResponseCertificateExtensionsSan {
	return v.value
}

func (v *NullablePublicProfileResponseCertificateExtensionsSan) Set(val *PublicProfileResponseCertificateExtensionsSan) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicProfileResponseCertificateExtensionsSan) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicProfileResponseCertificateExtensionsSan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicProfileResponseCertificateExtensionsSan(val *PublicProfileResponseCertificateExtensionsSan) *NullablePublicProfileResponseCertificateExtensionsSan {
	return &NullablePublicProfileResponseCertificateExtensionsSan{value: val, isSet: true}
}

func (v NullablePublicProfileResponseCertificateExtensionsSan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicProfileResponseCertificateExtensionsSan) UnmarshalJSON(src []byte) error {
	v.isSet = true

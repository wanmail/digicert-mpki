...
// MpkiApiV1SeatSeatIdDelete200ResponseAllOf struct for MpkiApiV1SeatSeatIdDelete200ResponseAllOf
type MpkiApiV1SeatSeatIdDelete200ResponseAllOf struct {
	// Primary seat identifier
...
func NewMpkiApiV1SeatSeatIdDelete200ResponseAllOf() *MpkiApiV1SeatSeatIdDelete200ResponseAllOf {
	this := MpkiApiV1SeatSeatIdDelete200ResponseAllOf{}
	return &this
}
...
func (o MpkiApiV1SeatSeatIdDelete200ResponseAllOf) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf struct {
	value *MpkiApiV1SeatSeatIdDelete200ResponseAllOf
	isSet bool
}

func (v NullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf) Get() *MpkiApiV1SeatSeatIdDelete200ResponseAllOf {
	return v.value
}

func (v *NullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf) Set(val *MpkiApiV1SeatSeatIdDelete200ResponseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf(val *MpkiApiV1SeatSeatIdDelete200ResponseAllOf) *NullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf {
	return &NullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf{value: val, isSet: true}
}

func (v NullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1SeatSeatIdDelete200ResponseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

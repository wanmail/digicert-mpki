...
// PagingParameters struct for PagingParameters
...
func (o PagingParameters) MarshalJSON() ([]byte, error) {
...
type NullablePagingParameters struct {
	value *PagingParameters
	isSet bool
}

func (v NullablePagingParameters) Get() *PagingParameters {
	return v.value
}

func (v *NullablePagingParameters) Set(val *PagingParameters) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingParameters) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingParameters(val *PagingParameters) *NullablePagingParameters {
	return &NullablePagingParameters{value: val, isSet: true}
}

func (v NullablePagingParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true

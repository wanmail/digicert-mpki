...
// MpkiApiV1AuditLogGet200Response struct for MpkiApiV1AuditLogGet200Response
type MpkiApiV1AuditLogGet200Response struct {
...
func NewMpkiApiV1AuditLogGet200Response(total int32, offset int32, limit int32, items []AuditLogItem) *MpkiApiV1AuditLogGet200Response {
	this := MpkiApiV1AuditLogGet200Response{}
	this.Total = total
	this.Offset = offset
	this.Limit = limit
	this.Items = items
...
func (o MpkiApiV1AuditLogGet200Response) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1AuditLogGet200Response struct {
	value *MpkiApiV1AuditLogGet200Response
	isSet bool
}

func (v NullableMpkiApiV1AuditLogGet200Response) Get() *MpkiApiV1AuditLogGet200Response {
	return v.value
}

func (v *NullableMpkiApiV1AuditLogGet200Response) Set(val *MpkiApiV1AuditLogGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1AuditLogGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1AuditLogGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1AuditLogGet200Response(val *MpkiApiV1AuditLogGet200Response) *NullableMpkiApiV1AuditLogGet200Response {
	return &NullableMpkiApiV1AuditLogGet200Response{value: val, isSet: true}
}

func (v NullableMpkiApiV1AuditLogGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1AuditLogGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

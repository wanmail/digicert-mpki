...
func (o IdDto) MarshalJSON() ([]byte, error) {
...
func (v NullableIdDto) Get() *IdDto {
	return v.value
}

func (v *NullableIdDto) Set(val *IdDto) {
	v.value = val
	v.isSet = true
}

func (v NullableIdDto) IsSet() bool {
	return v.isSet
}

func (v *NullableIdDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdDto(val *IdDto) *NullableIdDto {
	return &NullableIdDto{value: val, isSet: true}
}

func (v NullableIdDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdDto) UnmarshalJSON(src []byte) error {
	v.isSet = true

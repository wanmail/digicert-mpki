...
// DeliveryFormat the model 'DeliveryFormat'
type DeliveryFormat string

// List of DeliveryFormat
const (
	X509 DeliveryFormat = "x509"
	PKCS7 DeliveryFormat = "PKCS7"
)

// All allowed values of DeliveryFormat enum
var AllowedDeliveryFormatEnumValues = []DeliveryFormat{
	"x509",
	"PKCS7",
}

func (v *DeliveryFormat) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := DeliveryFormat(value)
	for _, existing := range AllowedDeliveryFormatEnumValues {
	...
	return fmt.Errorf("%+v is not a valid DeliveryFormat", value)
}

// NewDeliveryFormatFromValue returns a pointer to a valid DeliveryFormat
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewDeliveryFormatFromValue(v string) (*DeliveryFormat, error) {
	ev := DeliveryFormat(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for DeliveryFormat: valid values are %v", v, AllowedDeliveryFormatEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v DeliveryFormat) IsValid() bool {
	for _, existing := range AllowedDeliveryFormatEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to DeliveryFormat value
func (v DeliveryFormat) Ptr() *DeliveryFormat {
	return &v
}

type NullableDeliveryFormat struct {
	value *DeliveryFormat
	isSet bool
}

func (v NullableDeliveryFormat) Get() *DeliveryFormat {
	return v.value
}

func (v *NullableDeliveryFormat) Set(val *DeliveryFormat) {
	v.value = val
	v.isSet = true
}

func (v NullableDeliveryFormat) IsSet() bool {
	return v.isSet
}

func (v *NullableDeliveryFormat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeliveryFormat(val *DeliveryFormat) *NullableDeliveryFormat {
	return &NullableDeliveryFormat{value: val, isSet: true}
}

func (v NullableDeliveryFormat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeliveryFormat) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId struct for MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId
type MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId struct {
...
func NewMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId() *MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId {
	this := MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId{}
	return &this
}
...
func (o MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId struct {
	value *MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId
	isSet bool
}

func (v NullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId) Get() *MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId {
	return v.value
}

func (v *NullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId) Set(val *MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId(val *MpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId) *NullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId {
	return &NullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId{value: val, isSet: true}
}

func (v NullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1CertificateImportPost200ResponseInnerBusinessUnitId) UnmarshalJSON(src []byte) error {
	v.isSet = true

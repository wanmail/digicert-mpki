...
// AuditLogItemAccount struct for AuditLogItemAccount
type AuditLogItemAccount struct {
...
func (o AuditLogItemAccount) MarshalJSON() ([]byte, error) {
...
type NullableAuditLogItemAccount struct {
	value *AuditLogItemAccount
	isSet bool
}

func (v NullableAuditLogItemAccount) Get() *AuditLogItemAccount {
	return v.value
}

func (v *NullableAuditLogItemAccount) Set(val *AuditLogItemAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditLogItemAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditLogItemAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditLogItemAccount(val *AuditLogItemAccount) *NullableAuditLogItemAccount {
	return &NullableAuditLogItemAccount{value: val, isSet: true}
}

func (v NullableAuditLogItemAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditLogItemAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true

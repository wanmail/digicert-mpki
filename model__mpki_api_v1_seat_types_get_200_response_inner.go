...
// MpkiApiV1SeatTypesGet200ResponseInner struct for MpkiApiV1SeatTypesGet200ResponseInner
type MpkiApiV1SeatTypesGet200ResponseInner struct {
...
func NewMpkiApiV1SeatTypesGet200ResponseInner() *MpkiApiV1SeatTypesGet200ResponseInner {
	this := MpkiApiV1SeatTypesGet200ResponseInner{}
	return &this
}
...
func (o MpkiApiV1SeatTypesGet200ResponseInner) MarshalJSON() ([]byte, error) {
...
type NullableMpkiApiV1SeatTypesGet200ResponseInner struct {
	value *MpkiApiV1SeatTypesGet200ResponseInner
	isSet bool
}

func (v NullableMpkiApiV1SeatTypesGet200ResponseInner) Get() *MpkiApiV1SeatTypesGet200ResponseInner {
	return v.value
}

func (v *NullableMpkiApiV1SeatTypesGet200ResponseInner) Set(val *MpkiApiV1SeatTypesGet200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableMpkiApiV1SeatTypesGet200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableMpkiApiV1SeatTypesGet200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMpkiApiV1SeatTypesGet200ResponseInner(val *MpkiApiV1SeatTypesGet200ResponseInner) *NullableMpkiApiV1SeatTypesGet200ResponseInner {
	return &NullableMpkiApiV1SeatTypesGet200ResponseInner{value: val, isSet: true}
}

func (v NullableMpkiApiV1SeatTypesGet200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMpkiApiV1SeatTypesGet200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
